  ...
  return (
    ...
    >
      <EditorialThumbnailLink
        ...
        disableAmbientFloat
        panelClassName={cn(
          "relative h-[22rem] overflow-hidden rounded-[1.5rem] border border-[#d9c8b8]/70 sm:h-[26rem]",
  ...
  const card = (
    ...
    >
      <EditorialThumbnailLink
        ...
        disableAmbientFloat
        panelClassName={cn(
          "overflow-hidden rounded-[1.4rem] border border-[#dccbbb]/72 bg-gradient-to-br",
  ...
  return (
    ...
    >
      <EditorialThumbnailLink
        ...
        panelClassName={cn(
          "relative h-[18rem] overflow-hidden rounded-[1.4rem] border border-[#dccbbb]/72 sm:h-[20rem]",
...
function WritingCard({
  ...
  const card = (
    ...
    >
      <div
        className={cn(
          "overflow-hidden rounded-[1.4rem] border border-[#dccbbb]/72 bg-gradient-to-br p-4",
