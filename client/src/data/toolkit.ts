...
export const toolkitGroups: ToolkitGroup[] = [
  {
    ...
    heroItems: ["ChatGPT", "Obsidian", "Notion"],
    items: ["Claude", "Perplexity", "NotebookLM", "Miro", "Workflow maps", "FigJam"],
  ...
  },
  {
    ...
    heroItems: ["Figma", "Visily", "v0", "Cursor"],
  ...
  },
  {
    ...
    heroItems: ["Codex", "n8n", "MCPs"],
    items: ["Claude Code", "Subagents", "Make", "Zapier", "Supabase", "Vercel", "LangChain", "OpenAI Playground"],
  ...
  },
  {
    ...
    items: ["Mixpanel", "GA4", "Amplitude", "Loom", "Airtable"],
  ...
  },
  {
    ...
    heroItems: ["ClickUp", "Jira", "GitHub"],
    items: ["Confluence", "User stories", "Acceptance criteria", "UAT", "Release readiness"],
