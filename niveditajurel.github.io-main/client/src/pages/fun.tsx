...
function VisualCard({
  ...
  return (
    ...
    >
      {item.imageSrc ? (
        <div className={cn("relative min-h-[15rem] flex-1 overflow-hidden border-b border-[#dccbbb]/72 bg-[#f4eadf]", mediaClassName)}>
          <img
            src={item.imageSrc}
      ...
      <div className="flex flex-col gap-3 p-6">
        ...
        <h3 className="max-w-[16ch] text-balance font-editorial text-[clamp(1.75rem,2.2vw,2.5rem)] leading-[0.95] tracking-[-0.04em] text-[#221913]">
          {item.title}
        </h3>
        <p className="max-w-[34rem] text-sm leading-6 text-[#6b5848]">
          {item.description}
        </p>
        <div className="mt-1 inline-flex items-center gap-2 text-sm font-semibold text-[#b9653d] transition-colors group-hover/thumbnail:text-[#8f5636]">
