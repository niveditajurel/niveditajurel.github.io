...
// Floating CTA is shared by the proof surfaces that opt in with data-cursor.
function SiteHoverCursor() {
  const [location] = useLocation();
  const isEnabled = location === "/" || location === "/fun" || location === "/work" || location.startsWith("/projects");

  useEffect(() => {
    document.documentElement.classList.toggle("hover-cursor-active", isEnabled);
