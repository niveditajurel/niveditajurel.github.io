...
export function ProjectCard({ project, variants, className }: ProjectCardProps) {
  ...
  return (
    <motion.div
      ...
      variants={variants}
      className={cn(
        "group relative flex flex-col h-full overflow-hidden rounded-2xl bg-card/80 dark:bg-card/40 backdrop-blur-sm border border-border/50 shadow-sm hover:shadow-2xl transition-all duration-500 cursor-pointer",
        className
      )}
