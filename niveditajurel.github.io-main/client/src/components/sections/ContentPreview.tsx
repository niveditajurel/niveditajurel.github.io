...
function SupportingCard({
  ...
  return (
    ...
    >
      <p className="text-[0.72rem] font-semibold uppercase tracking-[0.18em] text-[var(--bp-ink-muted)]">
        {item.format}
      </p>
      <h3
        className={cn(
  ...
  return (
    <section id="content-preview" className="bg-transparent px-4 py-12 sm:px-6 lg:px-8 lg:py-14">
      <div className="relative mx-auto max-w-7xl border-t border-[var(--bp-hairline)] pt-6 lg:pt-7">
        <PixelWalker duration={90} delay={2} />
        <div className="mb-6 space-y-3">
          <div className="space-y-3">
            <p className="font-mono text-[0.7rem] uppercase tracking-[0.24em] text-[var(--bp-ink-muted)]">
              <PixelIcon name="pen" size={13} className="mr-2 inline-block align-[-2px]" />
              05 — Content
            </p>
